...
//adb's function name is ffs, ldb's function name is fldbfs
#define USB_MTP_LDB		"mtp,fldbfs\n"
#define USB_MTP_ACM_LDB		"mtp,acm,fldbfs\n"
#define USB_MTP_ADB_LDB		"mtp,ffs,fldbfs\n"
#define USB_MTP_ADB_ACM_LDB	"mtp,ffs,acm,fldbfs\n"
#define USB_MTP_ADB_UMS_LDB  "mtp,ffs,mass_storage,fldbfs\n"
#define USB_MTP_UMS_LDB		"mtp,mass_storage,fldbfs\n"
#define USB_MTP_UMS_ADB_LDB   "mtp,mass_storage,ffs,fldbfs\n"
...
//lenovo sw, yexh1 add for ldb interface 20140814
	struct mtp_ext_config_desc_function    function[4];   //3-->4
//lenovo sw, yexh1 add for ldb interface 20140814 end 
} mtp_ext_config_desc = {
	.header = {
				...
				const struct usb_ctrlrequest *ctrl)
{
	...
	if (ctrl->bRequestType ==
		...
		if (ctrl->bRequest == 1
			...
			case 0:			//mtp
//lenovo sw, yexh1 add for ldb interface 20140814			
                desc_size = sizeof(mtp_ext_config_desc) - 3 * sizeof(struct mtp_ext_config_desc_function);
//lenovo sw, yexh1 add for ldb interface 20140814 end
...
//lenovo sw, yexh1 add for ldb interface 20140814 end    
				...
				break;
//lenovo sw, yexh1 add for ldb interface 20140814
	    case 10:		//mtp,adb,acm,ldb	, with acm, failed so far
	    case 13:		//mtp,adb,mass_storage,ldb
            case 12:         //mtp,mass_storage,adb,ldb                
                desc_size = sizeof(mtp_ext_config_desc);
                mtp_ext_config_desc.header.dwLength = cpu_to_le32(desc_size);
                mtp_ext_config_desc.header.bCount = 4;
				value = (w_length < desc_size ? w_length : desc_size);
				memcpy(cdev->req->buf, &mtp_ext_config_desc, value);
				break;
//lenovo sw, yexh1 add for ldb interface 20140814 end
